...
3. **入植者思想対立（アフィニティ論争）**:
   - エイリアンとの共生を望むグループと、地球化（テラフォーミング）・純血主義を掲げるグループとの摩擦・暴動イベント。
...
6. **人類勢力・派閥間の外交・戦争イベント**:
   ...
   - エイリアンを「地球化」の障害と見なす勢力が、人類勢力間で連携し、エイリアン撲滅キャンペーンを開始。
7. **エイリアン取り込みイベント**:
   - 種族ごとに友好度を上げる、全体の友好度を上げる、種族を取り込む
8. **他派閥取り込みイベント**:
   - 部署ごとに友好度を上げる、全体の友好度を上げる、他派閥を取り込む
9. **民族・文化圏**
10. **企業**
    - 軍需・防衛産業などの製造業など、社会基盤の区分として
11. **変わる自分**
    - 他者との関わりの中で変わる自派閥
    - 製造業などカジュアル目に
